...
object Constants {
    val WordLen    = 32
    val StartAddr  = 0x00000000.U(WordLen.W)
    val OutAddr    = 0x00100000.U(WordLen.W)
    val PrintAddr  = 0x00100004.U(WordLen.W)
    ...
    val AluMul     = 19.U(ExeFunLen.W)
    val AluMulh    = 20.U(ExeFunLen.W)
    val AluMulhsu  = 21.U(ExeFunLen.W)
    val AluMulhu   = 22.U(ExeFunLen.W)
    val AluDiv     = 23.U(ExeFunLen.W)
    val AluDivu    = 24.U(ExeFunLen.W)
    val AluRem     = 25.U(ExeFunLen.W)
    val AluRemu    = 26.U(ExeFunLen.W)
    ...
    val MenSW      = 1.U(MenLen.W)
    val MenSH      = 2.U(MenLen.W)
    val MenSB      = 3.U(MenLen.W)
    ...
    val WbLW       = 1.U(WbSelLen.W)
    val WbLH       = 2.U(WbSelLen.W)
    val WbLHU      = 3.U(WbSelLen.W)
    val WbLB       = 4.U(WbSelLen.W)
    val WbLBU      = 5.U(WbSelLen.W)
    val WbPc       = 6.U(WbSelLen.W)
    val WbCsr      = 7.U(WbSelLen.W)
